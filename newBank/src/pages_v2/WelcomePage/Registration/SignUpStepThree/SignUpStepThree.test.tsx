...
import { SingUpStepThree } from "./index";
...
describe("render SingUpStepThree component", () => {
  beforeEach(() => {
    withProviders(<SingUpStepThree />);
  });
  ...
  it("Check if parts in document", () => {
    ...
    const signUp = screen.getByText("Sing up");

    expect(container).toBeInTheDocument;
    expect(radioBtn).toBeInTheDocument;
    expect(title).toBeInTheDocument;
    expect(signUp).toHaveTextContent("Sing up");
  ...
  it("Is rendered 'Button' and text 'Choose Identity Document type' ", () => {
    ...
    const identity = screen.getByText("Choose Identity Document type");
    ...
    expect(identity).toHaveTextContent("Choose Identity Document type");
    expect(identity).toHaveClass("radioBtn_subtitles");
  });

  it("SingUpStepThree snapshot", () => {
    const singUpStepThree = withProviders(<SingUpStepThree />);
    expect(singUpStepThree).toMatchSnapshot();
  });
});
