...
describe("Rendering SmsForm component DE", () => {
  beforeEach(() =>
    withProvidersDe(
      <SmsForm
        closeConfirmation={closeConfirmation}
  ...
  it("Rendering block with buttons DE", () => {
    const wrapper = document.querySelector(".button_group");
    ...
    expect(buttons).toHaveLength(2);
    expect(buttons[0]).toHaveTextContent("Bestätigungs-Code");
    expect(buttons[1]).toHaveTextContent("Absagen");
  });
});
