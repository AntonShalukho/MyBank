...
import { ArrowRightBlue } from "src/shared/assets/icons";

import { useInterval } from "src/shared/lib/hooks/useInterval";

import { SliderEllipsesAdv } from "./components/SliderEllipsesAdv";

import { AdvProps, AdvertisementProductsType } from "./types";

import { getAdvertisementProducts } from "./api/getAdvertisementProducts";
